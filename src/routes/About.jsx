  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 p-4 space-y-4 " >
        ...
        <div>
          <p className="mb-4">
            After graduating, I started my career as Publicity Assistant for an
            independent film distributor in London. Relocating to Los Angeles, I
            worked in PR for a range of clients including Twentieth Century Fox
            Home Entertainment, Columbia TriStar and BBC Video together with
            managing Academy Award campaigns for Aardman Animations.{" "}
          </p>
          ...
          <p className="mb-4">
            ...
            festival circuit – handling PR for clients in the fast-paced, highly
            competitive environment of the Cannes Film Festival, Berlin Film
            Festival, Venice Biennale, San Sebastian Film Festival, London Film
            Festival, London Film Market and others.{" "}
          </p>
