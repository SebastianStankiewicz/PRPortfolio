...
const WelcomeHero = () => {
  return (
    <>
<div
  className="relative min-h-screen bg-cover bg-center lg:bg-[url('../graphics/heroGraphic.svg')] lg:bg-no-repeat lg:bg-opacity-100 bg-[url('../graphics/heroGraphic.svg')] bg-opacity-30"
  style={{
